...
pasta_audios = r"C:\Users\kiko\Downloads\pasta_audios"

# Verifica se a pasta existe
if not os.path.exists(pasta_audios):
    print(f"A pasta {pasta_audios} não existe!")
else:
    ...
    if arquivo_audio:
        arquivo_convertido = arquivo_audio.rsplit(
            ".", 1)[0] + ".wav"  # Cria o nome do arquivo .wav
